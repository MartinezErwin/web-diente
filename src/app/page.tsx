...
export default function Home() {
  return (
    <main className="min-h-screen relative">
      ...
      <section className="w-full flex justify-start px-4 md:px-16 py-8 md:py-12 mt-50 md:mt-15">
        <div
        ...
        >
          ...
          <h1 className="text-white text-5xl md:text-6xl lg:text-8xl font-light leading-tight">
            Presenta una
            <br />
